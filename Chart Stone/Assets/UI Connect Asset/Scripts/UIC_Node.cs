...
public class UIC_Node : MonoBehaviour, I_UIC_Object, I_UIC_Draggable, I_UIC_Clickable
{
    ...
    // v2.2 - EnableDrag property of Nodes is now implemented and works to allow drag of lines from the node  
    public bool EnableDrag { get; set; }

    // v2.2 - DisableClick property of Nodes can now be set
    ...
    public void OnPointerUp()
    {
        ...
        if (closestFoundNode && EnableDrag)
        {
