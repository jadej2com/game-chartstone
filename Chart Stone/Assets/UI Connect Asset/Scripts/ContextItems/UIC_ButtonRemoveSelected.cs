...
public class UIC_ButtonRemoveSelected : MonoBehaviour, I_UIC_ContextItem, I_UIC_Object
{
    ...
    public void Action()
    {
        ...
        _uicManager.contextMenu.UpdateContextMenu();
    }
    ...
    public void OnChangeSelection()
    {
        ...
        if (_uicManager.selectedUIObjectsList.Count == 1)
        {
            gameObject.SetActive((_uicManager.selectedUIObjectsList[0] as I_UIC_Object).ID.IndexOf("Connection") == 0);
        }
        else
        {
